...
const projects = [
  {
    ...
    description: 'Platform manajemen kos-kosan digital dengan fitur booking, pembayaran, dan complaint management.',
    color: 'bg-hotpink',
    accent: '#F0097A',
    size: 'medium',
  ...
  },
  {
    ...
    description: 'Comprehensive brand identity system untuk startup fintech dengan design system lengkap.',
    color: 'bg-lime',
    accent: '#C8F060',
    size: 'medium',
  ...
  },
  {
    ...
    description: 'Situs galeri komprehensif untuk SMKN 4 Bogor yang mengelola berita, agenda, ekstrakurikuler, dan galeri foto sekolah.',
    color: 'bg-lime',
    accent: '#C8F060',
    size: 'medium',
  ...
  },
  {
    ...
    description: 'Strategi konten dan manajemen akun TikTok @bbriesh.id selama 1 bulan. Berhasil mencapai 54K views, 3K+ likes, dan interaksi komunitas yang tinggi.',
    color: 'bg-dark',
    accent: '#1A1A1A',
    size: 'medium',
  ...
  },
  {
    ...
    description: 'Perancangan antarmuka pengguna untuk platform pembelajaran daring yang komprehensif, mencakup landing page, dashboard admin, dan fitur manajemen kursus.',
    color: 'bg-cream',
    accent: '#F5F0EB',
    size: 'medium',
  ...
  },
  {
    ...
    description: 'Perancangan antarmuka pengguna untuk aplikasi mobile platform pembelajaran daring, mencakup splash screen, login, dashboard user, dan manajemen kursus.',
    color: 'bg-dark',
    accent: '#1A1A1A',
    size: 'medium',
